...
augFilename = '../Classification Results/TESTaugmentedPredictions_NN_SynP050_Runs8000_Filtered.csv'
empFilename = '../Classification Results/TESTempiricalPredictions_NN_Runs8000.csv'
