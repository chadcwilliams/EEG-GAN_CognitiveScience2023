...
augFilename = 'augmentedPredictions_SVM_SynP050_Runs8000_Filtered_TestClassification.csv'
empFilename = 'empiricalPredictions_SVM_Runs8000_TestClassification.csv'
####
