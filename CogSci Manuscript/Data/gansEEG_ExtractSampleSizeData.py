...
#Save File
saveFilename = 'data/training_data/Runs/gansTrialERP_len100_TestSS400.csv'
...
for sampleSize in np.arange(5,101,5):
    for run in range(20):
        ...
        #Save file
        saveFilename = 'data/training_data/Runs/gansTrialERP_len100_SS' + str(sampleSize).zfill(3) + '_Run'+ str(run).zfill(2) + '.csv'
