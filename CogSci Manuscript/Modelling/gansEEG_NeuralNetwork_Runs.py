...
proportionSynData = .5 #0.5 = 50 syn people
augFilename = 'augmentedPredictions_NN_SynP050_Runs8000_Filtered.csv'
empFilename = 'empiricalPredictions_NN_Runs8000_Filtered.csv'
